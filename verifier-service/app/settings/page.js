...
export default function SettingsPage() {
  ...
  return (
    <div className="min-h-screen">
      <Header title="Settings" subtitle="Configure your verifier service" />
      ...
      <div className="p-8 max-w-[1200px] mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h2 className="text-xl font-bold text-gray-900">
              About MyPersona Verifier
            </h2>
          </div>
          <p className="text-sm text-gray-500 mb-6 max-w-[700px] leading-relaxed">
            The Verifier Service enables businesses and service providers to
            verify user credentials using zero-knowledge proofs. Users prove
            their KYC status without revealing personal data.
          </p>
          ...
          <div className="bg-white rounded-xl border border-gray-100 p-6">
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 flex items-center justify-center bg-teal-500/10 rounded-xl text-teal-600">
                  <Globe size={24} />
                </div>
                <div>
                  <h3 className="text-base font-semibold text-gray-900 mb-1">
                  ...
                  <p className="text-sm text-gray-500">
                    All trust and revocation checks are performed on the Polygon
                    blockchain
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Instantly check if credentials are valid and have not been
                    revoked
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Perform verifications without connecting a wallet - all
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-gray-500 mb-6 max-w-[700px] leading-relaxed">
            These are the deployed contract addresses on Polygon Amoy Testnet
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2 text-sm font-medium text-gray-600">
                    <contract.icon size={16} className="text-violet-600" />
                ...
                <div className="flex items-center justify-between gap-3 px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg">
                  ...
                  <div className="flex gap-2 flex-shrink-0">
                    <button
                      className="w-8 h-8 flex items-center justify-center bg-white border border-gray-200 rounded text-gray-500 hover:border-violet-500 hover:text-violet-600 transition-all cursor-pointer"
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 text-center">
          <p className="text-sm text-gray-500">
            Built for{" "}
            <strong className="text-violet-600">RBI HaRBInger 2025</strong>{" "}
            Hackathon
          </p>
          <p className="text-xs text-gray-400 mt-2">
            MyPersona zk-KYC System • Polygon Amoy Testnet
          </p>
        </div>
      </div>
    </div>
