    ...
    <header className="flex items-center justify-between px-8 py-5 glass border-b border-gray-100 sticky top-0 z-40 min-h-[72px]">
      ...
      <div className="flex items-center gap-4">
        ...
        {isConnected && (
          <div>
            {isCorrectNetwork ? (
              <div className="flex items-center gap-2 px-3 py-2 network-badge rounded-full text-xs font-semibold text-blue-600">
        ...
        {isConnected && balance !== null && (
          <div className="flex items-center gap-2 px-3 py-2 bg-emerald-50 border border-emerald-200 rounded-full text-xs font-semibold text-emerald-700">
            <Coins size={14} />
        ...
        {isConnected ? (
          ...
          <button
            className="flex items-center gap-2 px-5 py-3 btn-primary-gradient rounded-full text-white text-sm font-semibold cursor-pointer transition-all shadow-md hover:-translate-y-0.5 hover:shadow-lg hover:shadow-blue-500/30 disabled:opacity-70 disabled:cursor-not-allowed"
            onClick={connect}
